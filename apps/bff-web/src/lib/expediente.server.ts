...
function mensajeError(status: number, cuerpo: string) {
  ...
  if (status === 403)
    return "El procesamiento automático está deshabilitado en este espacio de trabajo.";
  if (status === 429)
    return "Demasiadas solicitudes de procesamiento. Inténtalo de nuevo en unos minutos.";
