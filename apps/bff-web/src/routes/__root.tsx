...
import { suscribirCambiosAuth } from "@/features/auth";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sanciona Fleet · Gestión de sanciones de flota" },
      {
        name: "description",
        content:
          "Software para empresas españolas de transporte por carretera: centraliza sanciones, plazos, vehículos y conductores.",
      },
...
function RootComponent() {
  ...
  useEffect(() => {
    return suscribirCambiosAuth((event) => {
