/**
 * Formato y utilidades de presentación puras, sin dependencia de ningún
 * dominio de negocio concreto. Antes vivían mezcladas con las constantes de
 * dominio en lib/fleet.ts — ver docs/refactor/PLAN-REFACTOR-FRONTEND.md §2.3.
 */
