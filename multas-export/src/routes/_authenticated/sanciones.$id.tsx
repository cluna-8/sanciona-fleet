...
type Actuacion = { id: string; action_type: string; description: string | null; created_at: string };
...
function FichaSancion() {
  ...
  const plazo = [sancion.payment_deadline, sancion.appeal_deadline].filter(Boolean).sort()[0] ?? null;
          ...
          <div className="card-surface p-5">
            ...
            <dl className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <Dato
                ...
                valor={sancion.discounted_amount != null ? formatoImporte(sancion.discounted_amount) : "—"}
              />
              <Dato
                titulo="Vehículo"
    ...
    <div className="card-surface overflow-hidden">
      ...
      <div className="grid gap-x-6 gap-y-2 px-5 py-4 sm:grid-cols-2">
        {entradas.map(([clave, campo]) => (
          <div key={clave} className="flex items-baseline justify-between gap-3 border-b border-border/60 py-1">
