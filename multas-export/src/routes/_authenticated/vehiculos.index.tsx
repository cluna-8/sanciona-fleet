            ...
            <DialogContent>
              ...
              >
                <div className="space-y-1.5">
                  ...
                  <Input name="registration_number" maxLength={15} required placeholder="1234 ABC" />
                ...
                {(vehiculos ?? []).map((v) => {
                  ...
                  return (
                    <tr key={v.id} className="border-t border-border hover:bg-secondary/40">
                      ...
                      <td className="px-4 py-2 text-right tabular-nums">{formatoImporte(importe)}</td>
      ...
      <DialogContent>
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              <Label>Código interno</Label>
              <Input name="internal_code" maxLength={30} defaultValue={vehiculo.internal_code ?? ""} />
            </div>
            <div className="space-y-1.5">
              <Label>Tipo</Label>
              <Select value={tipo} onValueChange={setTipo}>
